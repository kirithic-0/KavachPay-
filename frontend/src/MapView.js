    ...
    return (
        <div style={{ backgroundColor: '#f5f7fa', minHeight: '100vh', fontFamily: 'Arial' }}>
            ...
            <div style={{ padding: '16px', maxWidth: '700px', margin: '0 auto' }}>
                ...
                <h2 style={{ color: '#1A56A0', fontSize: '22px', fontWeight: 'bold', marginBottom: '4px' }}>🗺️ Zone Risk Map</h2>
                        ...
                        <div style={{ display: 'flex', gap: '6px' }}>
                            {['all', 'high', 'medium', 'low'].map(f => (
                                <button key={f} onClick={() => setFilterRisk(f)}
                                    style={{ padding: '4px 10px', borderRadius: '12px', border: 'none', cursor: 'pointer', fontSize: '11px', fontWeight: 'bold', backgroundColor: filterRisk === f ? '#1A56A0' : '#f0f0f0', color: filterRisk === f ? 'white' : '#555' }}>
                ...
                <div style={{ borderRadius: '16px', overflow: 'hidden', boxShadow: '0 4px 20px rgba(0,0,0,0.12)', marginBottom: '14px' }}>
                    ...
                    background-color: #1A56A0; border: 3px solid white;
                        ...
                        {pinnedZone ? (
                            <div>
                                ...
                                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '10px', marginBottom: '12px' }}>
                                    {[
                                        { label: 'Weekly Premium', value: '₹' + pinnedZone.premium, color: '#1A56A0' },
                                ...
                                <div style={{ backgroundColor: '#D6E4F7', borderRadius: '10px', padding: '12px' }}>
                                    <p style={{ color: '#1A56A0', fontSize: '13px', fontWeight: 'bold' }}>
                ...
                <div style={{ backgroundColor: 'white', borderRadius: '14px', padding: '16px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr', gap: '8px' }}>
                        {[
                            { label: 'Zones', value: ZONE_RISK_DATA.length + '+', color: '#1A56A0' },
                            { label: 'Cities', value: '8 + T2', color: '#1A56A0' },
